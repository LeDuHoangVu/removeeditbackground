...
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QGraphicsPixmapItem, QGraphicsScene, QFileDialog
from rembg import remove
from PlanBB import Ui_MainWindow
...
class Main(QWidget):
    ...
    def __init__(self):
        ...
        self.mwg.sliderMedian.valueChanged['int'].connect(self.medi_value)
        ...
        self.mwg.remove_background.clicked.connect(self.removebackground)

        # Tools
        self.mwg.actionLeft_Rotation.triggered.connect(lambda: self.rotate(cv2.ROTATE_90_COUNTERCLOCKWISE))
        self.mwg.actionRight_Rotation.triggered.connect(lambda: self.rotate(cv2.ROTATE_90_CLOCKWISE))
    ...
    def reset(self):
        ...
        self.mwg.sliderMedian.setValue(self.medi_value_now)
    ...
    def process_Color(self, img):
        img = self.adjust.change_Color(self.image, self.red_value_now, self.green_value_now, self.blue_value_now,
                                       self.alpha_value_now)
        return img
